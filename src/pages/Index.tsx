...
const testimonials: { name: string; city: string; role: string; quote: string; img?: string; video?: string; moto: string }[] = [
  ...
  { name: "Anderson F.", city: "Belém, PA", role: "Motoclub", quote: "Calor de 40 graus e chuva forte todo dia. MotoPlay não falhou nenhuma vez. IP67 é real.", video: "/videos/depoimento-video-9.mp4", moto: "Honda CG 160 Start" },
      ...
      <section className="py-10">
        <div className="container px-4 text-center space-y-4">
          ...
          <Button asChild size="lg" className="h-[52px] w-full rounded-full text-[14px] font-extrabold shadow-cta">
            <a
              href={offerUnlocked ? "https://seguro.carrinhomotoplay.online/api/public/shopify?product=3084547718634&store=30845" : "#compatibilidade"}
